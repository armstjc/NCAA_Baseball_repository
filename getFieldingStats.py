...
def getSeasonFieldingStats(season=2020):
    '''
    Gets literally all stats in D1 NCAA Mens Baseball.
    This will take some time to complete.
    '''
    ...
    #print(schools)
    hasRoster = True
    for s in range(80,max_schools):
        i = schools[s]
        coll_count += 1
        #print(f'{coll_count}/{max_schools} {i}')
        print(f'{s}/{max_schools} {i}')
        try:
        ...
        if hasRoster == True:
            for j in rost.index:
                ...
                try:
                    ...
                    print('couldn\'t download the stats for this player')
                    pass
...
def main():
    print('starting up')
    #getSeasonFieldingStats(season=2021)
    getSeasonFieldingStats(season=2019)
